...
namespace FNPlus.Utilities
{
    ...
    public class LanDiscovery
    {
        ...
        public ushort BroadcastPort
        {
            ...
            set
            {
                ...
                if (value != _broadcastPort)
                {
                    ...
                    {
                        RiptideLogger.Log(Riptide.Utils.LogType.Error, $"Failed to bind broadcast socket! Make sure port {_broadcastPort} isn't being used by another {nameof(LanDiscovery)} insance or by another application on this machine, or use a different port for broadcasting. Error: {ex}");
                    }
        ...
        public void SendBroadcast()
        {
            ...
            {
                RiptideLogger.Log(Riptide.Utils.LogType.Error, "LAN Discovery is in listen mode. Change the mode before broadcasting!");
                return;
            }
        ...
        public void StartListening()
        {
            ...
            {
                RiptideLogger.Log(Riptide.Utils.LogType.Error, "LAN Discovery is in broadcast mode. Change the mode before listening!");
                return;
            }
        ...
        {
            actionQueue.Enqueue(() => HostDiscovered?.Invoke(this, new HostDiscoveredEventArgs(ip, port)));
        }
    }
